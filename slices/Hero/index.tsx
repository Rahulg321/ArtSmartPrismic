...
const Hero = ({ slice }: HeroProps): JSX.Element => {
  return (
    <BackgroundImageSection
      ...
      minheight="90vh"
      backgroundImageUrl="https://images.unsplash.com/photo-1499892477393-f675706cbe6e?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
    >
      <div className="flex flex-col justify-center px-12 gap-4">
        ...
        <span className="text-pretty block">{slice.primary.hero_tagline}</span>
